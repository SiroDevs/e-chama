    ...
    <Paper sx={{ p: { xs: 2, sm: 3 } }}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <DetailItem label="Sex" value={member.sex} icon={<PersonIcon fontSize="small" />} />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <DetailItem 
            label="Date of Birth" 
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <DetailItem label="ID Number" value={member.id_number} icon={<AssignmentIndIcon fontSize="small" />} />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <DetailItem label="KRA PIN" value={member.kra_pin} icon={<AssignmentIndIcon fontSize="small" />} />
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <DetailItem label="Email" value={member.email} icon={<Email fontSize="small" />} />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <DetailItem label="Phone" value={member.phone} icon={<Phone fontSize="small" />} />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <DetailItem label="Address" value={`${member.address}, ${member.country}`} icon={<LocationOnIcon fontSize="small" />} />
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <DetailItem label="Role" value={member.role} icon={<PersonIcon fontSize="small" />} />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <DetailItem 
            label="Joined Date" 
